...
## Running older versions of macOS

If you want to run Mojave, Catalina or Big Sur, you have to replace [AirportItlwm](https://github.com/OpenIntelWireless/itlwm/releases) with the one appropiate to your version of macOS.
